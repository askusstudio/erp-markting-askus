  ...
  dirs.forEach(dir => {
    ...
    walkDir(fullPath, (filePath) => {
      if (filePath.endsWith('.tsx') || filePath.endsWith('.ts')) {
        ...
        // Remove dark: classes. Using \b to ensure word boundary, though dark: starts with d.
        // It matches "dark:" followed by anything until a space, quote, or backtick.
        ...
        content = content.replace(/ring-blue-500\/20/g, 'ring-violet-400/50');
        ...
        content = content.replace(/ring-emerald-600\/20/g, 'ring-teal-500/50');
        ...
        content = content.replace(/ring-red-600\/20/g, 'ring-rose-500/50');
